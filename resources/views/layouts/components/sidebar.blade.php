        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-white">
          <div class="app-brand demo">
            <a href="#" class="app-brand-link">
                ...
                <span class="text-primary">
                  <svg width="30" height="24" viewBox="0 0 250 196" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path opacity="0.077704" fill-rule="evenodd" clip-rule="evenodd"
                      ...
                      fill="black" />
                    <path opacity="0.077704" fill-rule="evenodd" clip-rule="evenodd" d="M250 65.2656L189.516 99.0497V120.886L250 65.2656Z"
                      fill="black" />
                    <path fill-rule="evenodd" clip-rule="evenodd"
              ...
              <span class="app-brand-text demo menu-text fw-semibold ms-2">Grand Luxury</span>
            </a>
          </div>
...
<!-- Tipe Kamar -->
<li class="menu-item {{ request()->routeIs('admin.tipekamar.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.tipekamar.index') }}" class="menu-link">
    <i class="menu-icon icon-base ri ri-hotel-bed-line"></i>
    <div data-i18n="TipeKamar">Tipe Kamar</div>
  </a>
</li>

<!-- Kamar -->
<li class="menu-item {{ request()->routeIs('admin.kamar.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.kamar.index') }}" class="menu-link">
    <i class="menu-icon icon-base ri ri-hotel-bed-line"></i>
    <div data-i18n="TipeKamar">Kamar</div>
  </a>
</li>
...
<li class="menu-item {{ request()->routeIs('admin.riwayat.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.riwayat.index') }}" class="menu-link">
    <i class="menu-icon icon-base ri ri-time-line"></i>
    <div data-i18n="UserManagement">Riwayat</div>
  </a>
</li>
<!-- laporan -->
<li class="menu-item {{ request()->routeIs('admin.laporan.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.laporan.index') }}" class="menu-link">
    ...
    <div data-i18n="UserManagement">Laporan</div>
  </a>
</li>
...
<!-- Riwayat Pemasukan -->
<li class="menu-item {{ request()->routeIs('admin.pemasukan.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.pemasukan.index') }}" class="menu-link">
    <i class="menu-icon icon-base ri ri-money-dollar-circle-line"></i>
    <div data-i18n="UserManagement">Pemasukan</div>
  </a>
</li>

<!-- Riwayat Pengeluaran -->
<li class="menu-item {{ request()->routeIs('admin.pengeluaran.*') ? 'active open' : '' }}">
  <a href="{{ route('admin.pengeluaran.index') }}" class="menu-link">
    <i class="menu-icon icon-base ri ri-hand-coin-line"></i>
    <div data-i18n="UserManagement">Pengeluaran</div>
  </a>
</li>
